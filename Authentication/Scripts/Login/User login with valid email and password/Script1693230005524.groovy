...
WebUI.click(findTestObject('Object Repository/Login/Login Success/Page_Rize.inc HR Platform/button_Sign in'))

WebUI.click(findTestObject('Object Repository/Login/Login Success/Page_Rize.inc HR Platform/span_'))
